<div class="wrap">
    <h6><?php echo session_id(); ?></h6>
    <h6><?php echo ini_get('session.name'); echo "<br/>" . $login_name; echo "<br/>" . $_SESSION['last_login_timestamp'] . " : " . time(); ?></h6>
<header class="page-header">
            <div class="navbar">
                <ul class="nav navbar-nav navbar-right pull-right">
                    ...
                    <li class="hidden-xs dropdown">
                        ...
                        <ul id="account-menu" class="dropdown-menu account" role="menu">
                            <li role="presentation" class="account-picture">
                                <img src="img/2.jpg" alt=""> <?php if(isset($_SESSION['login']['username'])) echo $_SESSION['login']['username']; ?>
                            </li>
                            <li role="presentation">
                                <a href="index.php?com=user&act=man" class="link">
                    ...
                    <li class="hidden-xs"><a href="index.php?com=user&act=logout"><i class="fa fa-sign-out"></i></a></li>
                </ul>
